...
const OneWeekForecast = z.object({
  publishingOffice: z.string(),
  reportDatetime: z.string(),
  timeSeries: z.tuple([OneWeekForecastTimeSeriesWeather, OneWeekForecastTimeSeriesTemps]),
  tempAverage: z.optional(z.object({
    areas: z.array(z.object({
      area: z.object({
        name: z.string(),
        code: z.string(),
  ...
  precipAverage: z.optional(z.object({
    areas: z.array(z.object({
      area: z.object({
        name: z.string(),
        code: z.string(),
...
export const ZWeatherResponse = z.tuple([
  ThreeDayForecast,
  OneWeekForecast,
])
