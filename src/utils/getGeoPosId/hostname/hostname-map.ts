...
const parsePlalaHostnameFunc = (hostname: string) => {
...
export const parsePlalaHostname: HostnameParserInfo = {
  name: "ぷらら",
  domain: "plala.or.jp",
  regex: /a0(\d\d)\.ap\.plala\.or\.jp$/,
  prefixMap: {},
  parser: parsePlalaHostnameFunc,
};
